...
class StoryUIApp extends StatefulWidget {
  @override
  _StoryUIAppState createState() => _StoryUIAppState();
}

class _StoryUIAppState extends State<StoryUIApp> {
  ...
  Widget build(BuildContext context) {
    return AspectRatio(
      ...
      child: LayoutBuilder(builder: (context, contraints) {
        ...
        print("cardAspectRatio : ${cardAspectRatio}");
        ...
        print("heightOfPrimaryCard : ${heightOfPrimaryCard}");
